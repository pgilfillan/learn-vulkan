...
bool HelloTriangleApplication::isDeviceSuitable(VkPhysicalDevice device) {
	// Get device properties (for show only)
...
4. Create surface
5. Create swap chain
6. Get images from swap chain
7. Create image views
8. Create render pass
9. Load shaders and create shader modules
10. Create viewport, rasterizer etc. (fixed functions)
11. Create graphics pipeline
12. Create frame buffers
13. Create command pool
14. Create command buffers
15. Create semaphores
16. In main loop: submit command buffer, present the image
*/